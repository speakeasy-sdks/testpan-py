...
class ServerlessPolicies:
    ...
    def get_serverless_policy(self) -> operations.GetServerlessPolicyResponse:
        ...
        hook_ctx = HookContext(operation_id='get_/serverlessPolicy', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetServerlessPolicyResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[shared.ServerlessPolicy])
                res.serverless_policy = out
            else:
    ...
    def put_serverless_policy(self, request: shared.ServerlessPolicy) -> operations.PutServerlessPolicyResponse:
        ...
        hook_ctx = HookContext(operation_id='put_/serverlessPolicy', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.PutServerlessPolicyResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
