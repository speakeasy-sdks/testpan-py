...
class Telemetries:
    ...
    def get_app_telemetries(self, request: operations.GetAppTelemetriesRequest) -> operations.GetAppTelemetriesResponse:
        ...
        hook_ctx = HookContext(operation_id='get_/appTelemetries', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        query_params = { **utils.get_query_params(operations.GetAppTelemetriesRequest, request), **query_params }
        ...
        res = operations.GetAppTelemetriesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_app_telemetries_app_telemetry_id_(self, request: operations.GetAppTelemetriesAppTelemetryIDRequest) -> operations.GetAppTelemetriesAppTelemetryIDResponse:
        ...
        hook_ctx = HookContext(operation_id='get_/appTelemetries/{appTelemetryId}', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GetAppTelemetriesAppTelemetryIDResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_app_telemetries_app_telemetry_id_api_risk_info(self, request: operations.GetAppTelemetriesAppTelemetryIDAPIRiskInfoRequest) -> operations.GetAppTelemetriesAppTelemetryIDAPIRiskInfoResponse:
        ...
        hook_ctx = HookContext(operation_id='get_/appTelemetries/{appTelemetryId}/apiRiskInfo', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GetAppTelemetriesAppTelemetryIDAPIRiskInfoResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_app_telemetries_app_telemetry_id_image_packages(self, request: operations.GetAppTelemetriesAppTelemetryIDImagePackagesRequest) -> operations.GetAppTelemetriesAppTelemetryIDImagePackagesResponse:
        ...
        hook_ctx = HookContext(operation_id='get_/appTelemetries/{appTelemetryId}/imagePackages', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GetAppTelemetriesAppTelemetryIDImagePackagesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_app_telemetries_app_telemetry_id_injection_info(self, request: operations.GetAppTelemetriesAppTelemetryIDInjectionInfoRequest) -> operations.GetAppTelemetriesAppTelemetryIDInjectionInfoResponse:
        ...
        hook_ctx = HookContext(operation_id='get_/appTelemetries/{appTelemetryId}/injectionInfo', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GetAppTelemetriesAppTelemetryIDInjectionInfoResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_connection_telemetries(self, request: operations.GetConnectionTelemetriesRequest) -> operations.GetConnectionTelemetriesResponse:
        ...
        hook_ctx = HookContext(operation_id='get_/connectionTelemetries', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        query_params = { **utils.get_query_params(operations.GetConnectionTelemetriesRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.GetConnectionTelemetriesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_connection_telemetries_connection_telemetry_id_(self, request: operations.GetConnectionTelemetriesConnectionTelemetryIDRequest) -> operations.GetConnectionTelemetriesConnectionTelemetryIDResponse:
        ...
        hook_ctx = HookContext(operation_id='get_/connectionTelemetries/{connectionTelemetryId}', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        query_params = { **utils.get_query_params(operations.GetConnectionTelemetriesConnectionTelemetryIDRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.GetConnectionTelemetriesConnectionTelemetryIDResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
