...
class TrustedSigners:
    ...
    def delete_trusted_signers_trusted_signer_id_(self, request: operations.DeleteTrustedSignersTrustedSignerIDRequest) -> operations.DeleteTrustedSignersTrustedSignerIDResponse:
        ...
        hook_ctx = HookContext(operation_id='delete_/trustedSigners/{trustedSignerId}', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.DeleteTrustedSignersTrustedSignerIDResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_trusted_signers(self, request: operations.GetTrustedSignersRequest) -> operations.GetTrustedSignersResponse:
        ...
        hook_ctx = HookContext(operation_id='get_/trustedSigners', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        query_params = { **utils.get_query_params(operations.GetTrustedSignersRequest, request), **query_params }
        ...
        res = operations.GetTrustedSignersResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_trusted_signers_trusted_signer_id_(self, request: operations.GetTrustedSignersTrustedSignerIDRequest) -> operations.GetTrustedSignersTrustedSignerIDResponse:
        ...
        hook_ctx = HookContext(operation_id='get_/trustedSigners/{trustedSignerId}', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GetTrustedSignersTrustedSignerIDResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def post_trusted_signers(self, request: shared.TrustedSignerInput) -> operations.PostTrustedSignersResponse:
        ...
        hook_ctx = HookContext(operation_id='post_/trustedSigners', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.PostTrustedSignersResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def put_trusted_signers_trusted_signer_id_(self, request: operations.PutTrustedSignersTrustedSignerIDRequest) -> operations.PutTrustedSignersTrustedSignerIDResponse:
        ...
        hook_ctx = HookContext(operation_id='put_/trustedSigners/{trustedSignerId}', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.PutTrustedSignersTrustedSignerIDResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
