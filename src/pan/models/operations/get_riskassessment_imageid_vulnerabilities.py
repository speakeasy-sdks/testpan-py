...
class GetRiskAssessmentImageIDVulnerabilitiesRequest:
    ...
    sort_key: GetRiskAssessmentImageIDVulnerabilitiesSortKey = dataclasses.field(metadata={'query_param': { 'field_name': 'sortKey', 'style': 'form', 'explode': True }})
    r"""risk assessment image sort key."""
    ...
    sort_dir: Optional[GetRiskAssessmentImageIDVulnerabilitiesSortDir] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sortDir', 'style': 'form', 'explode': True }})
    r"""sorting direction"""
