...
import dataclasses
from .periodicjobexpression import PeriodicJobExpression
...
class RiskAssessmentClusterScanConfig:
    ...
    minimum_severity: VulnerabilitySeverity = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('minimumSeverity') }})
    ...
    periodic_job_expression: Optional[PeriodicJobExpression] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('periodicJobExpression'), 'exclude': lambda f: f is None }})
