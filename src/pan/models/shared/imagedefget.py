...
from .imagesourcetype import ImageSourceType
...
class ImageDefGet:
    ...
    image_source_type: Optional[ImageSourceType] = dataclasses.field(default=ImageSourceType.DOCKER_PLUGIN_CI, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('imageSourceType'), 'exclude': lambda f: f is None }})
