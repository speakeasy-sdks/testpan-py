...
class ClusterEventRuleRecommendation:
    cluster_event_rule: Optional[KubernetesAPIRule] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('clusterEventRule'), 'exclude': lambda f: f is None }})
