...
class Agents:
    agents: Optional[List[Agent]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('agents'), 'exclude': lambda f: f is None }})
