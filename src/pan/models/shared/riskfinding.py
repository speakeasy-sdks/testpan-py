...
from .riskfindingaffectedelements import RiskFindingAffectedElements
...
class RiskFinding:
    affected_elements: Optional[RiskFindingAffectedElements] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('affectedElements'), 'exclude': lambda f: f is None }})
