...
from .networkappruletype import NetworkAppRuleType
...
class EnvironmentRuleBasic:
    ...
    rule_type: Optional[NetworkAppRuleType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ruleType'), 'exclude': lambda f: f is None }})
