...
import dataclasses
from .backgroundjobstate import BackgroundJobState
...
class BackgroundJobResponse:
    ...
    state: Optional[BackgroundJobState] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
