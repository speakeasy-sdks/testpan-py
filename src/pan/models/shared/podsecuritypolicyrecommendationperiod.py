...
import dataclasses
from ..shared import podsecuritypolicyrecommendation as shared_podsecuritypolicyrecommendation
...
class PodSecurityPolicyRecommendationPeriod:
    pod_security_policy_recommendations: Optional[List[shared_podsecuritypolicyrecommendation.PodSecurityPolicyRecommendation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('podSecurityPolicyRecommendations'), 'exclude': lambda f: f is None }})
