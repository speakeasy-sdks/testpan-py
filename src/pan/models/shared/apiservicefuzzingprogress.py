...
from .apifuzzingtestconfiguration import APIFuzzingTestConfiguration
...
class APIServiceFuzzingProgress:
    ...
    test_configuration: Optional[APIFuzzingTestConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('testConfiguration'), 'exclude': lambda f: f is None }})
