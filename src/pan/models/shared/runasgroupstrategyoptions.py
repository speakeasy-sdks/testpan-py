...
from .runasgroupstrategy import RunAsGroupStrategy
...
class RunAsGroupStrategyOptions:
    ...
    rule: Optional[RunAsGroupStrategy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rule'), 'exclude': lambda f: f is None }})
